/*
 * VERSION UNIFICADA: BIPOLAR + UNIPOLAR
  La seleccion se realiza es en mpap.h

     //#define MOTOR_TYPE BIPOLAR_MOTOR
    #define MOTOR_TYPE UNIPOLAR_MOTOR

    Entrega final del firmware el viernes 30/10/2020
...
void bipolar_test(void);//eliminar solo de prueba
void main(void)
{
    int8_t sm0 = 0;
...
/*
 * PWM = 20KHz
  TMR1 esta configurado para esa freq. de PWM -> T = 50us, este tiempo ocasiona interrupciones, y son usados
  para el ustepping en el caso del motor Unipolar
