...
#define iKB_H_
    ...
    #ifdef iKEY
        #define PORTWxKB_KEY0 		PORTC    //kup
        #define PORTRxKB_KEY0 		PINC
        #define CONFIGIOxKB_KEY0 	DDRC
        #define PINxKB_KEY0 		4

        #define PORTWxKB_KEY1 		PORTC    //kdwown
        #define PORTRxKB_KEY1 		PINC
        #define CONFIGIOxKB_KEY1 	DDRC
        #define PINxKB_KEY1 		5

        #define PORTWxKB_KEY2 		PORTC    //k+
        #define PORTRxKB_KEY2 		PINC
        #define CONFIGIOxKB_KEY2 	DDRC
        #define PINxKB_KEY2 		6

        #define PORTWxKB_KEY3 		PORTC    //k-
        #define PORTRxKB_KEY3 		PINC
        #define CONFIGIOxKB_KEY3 	DDRC
        #define PINxKB_KEY3 		7

        #define PORTWxKB_KEY4 		PORTD    //kenter/flush
        #define PORTRxKB_KEY4 		PIND
        #define CONFIGIOxKB_KEY4 	DDRD
